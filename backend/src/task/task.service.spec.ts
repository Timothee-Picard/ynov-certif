...
describe('TaskService', () => {
    ...
    it('create() -> NotFound si la liste est absente', async () => {
        ...
        await expect(service.create(userId, listId, {} as any)).rejects.toBeInstanceOf(
            NotFoundException,
        )
    })
    ...
    it('update() -> NotFound si la tâche est absente', async () => {
        ...
        await expect(service.update(userId, taskId, {} as any)).rejects.toBeInstanceOf(
            NotFoundException,
        )
    })
    ...
    it('update() -> Forbidden si la tâche appartient à un autre user', async () => {
        ...
        await expect(service.update(userId, taskId, { title: 'X' } as any)).rejects.toBeInstanceOf(
            ForbiddenException,
        )
    })
    ...
    it('toggleComplete() -> NotFound si la tâche est absente', async () => {
        taskRepo.findOne!.mockResolvedValue(null)
        await expect(service.toggleComplete(userId, taskId)).rejects.toBeInstanceOf(
            NotFoundException,
        )
    })
    ...
    it('remove() -> NotFound si la tâche est absente', async () => {
        taskRepo.findOne!.mockResolvedValue(null)
        await expect(service.remove(userId, taskId)).rejects.toBeInstanceOf(NotFoundException)
    })
    ...
    it('remove() -> Forbidden si la tâche appartient à un autre user', async () => {
        ...
        await expect(service.remove(userId, taskId)).rejects.toBeInstanceOf(ForbiddenException)
    })
})
