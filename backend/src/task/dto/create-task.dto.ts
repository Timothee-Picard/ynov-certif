...
export class CreateTaskDto {
	...
	@ApiPropertyOptional({ example: 'Acheter du lait avant 18h', description: 'Description optionnelle' })
	@IsOptional()
	@IsString()
	description?: string;
	...
	@ApiPropertyOptional({ example: '2025-08-03T18:00:00Z', description: 'Date limite (ISO 8601)' })
	@IsOptional()
	@IsDateString()
	dueDate?: string;
