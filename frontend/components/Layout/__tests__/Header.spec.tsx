...
describe('Header', () => {
	...
	it('met en surbrillance "Mes Listes" quand pathname === "/"', () => {
		...
		expect(listesBtn.className).toContain('bg-blue-100');
		expect(listesBtn.className).toContain('text-blue-700');
		expect(profilBtn.className).not.toContain('bg-blue-100');
	});
	...
	it('met en surbrillance "Profil" quand pathname === "/profil"', () => {
		...
		expect(profilBtn.className).toContain('bg-blue-100');
		expect(profilBtn.className).toContain('text-blue-700');
		expect(listesBtn.className).not.toContain('bg-blue-100');
	});
