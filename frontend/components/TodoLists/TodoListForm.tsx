			...
			>
				<div className="p-6">
					<div className="flex items-center justify-between mb-6">
						<div>
							<h2 id={titleId} className="text-xl font-semibold text-gray-900" data-testid="todolistform-title">
								{list ? 'Modifier la liste' : 'Nouvelle liste'}
							</h2>
							<p id={descId} className="sr-only">
								Formulaire de {list ? 'modification' : 'création'} d’une liste de tâches
							</p>
                ...
                {list ? 'editing' : 'creating'}
					...
					<form onSubmit={handleSubmit} className="space-y-6" data-testid="todolistform-form">
						<div>
						...
						<fieldset aria-labelledby="color-legend">
							<legend id="color-legend" className="block text-sm font-medium text-gray-700 mb-3">
								Couleur
							</legend>
							<div
									...
									return (
										<button
											...
											className={`w-8 h-8 rounded-full border-2 transition-all ${
												checked ? 'border-gray-800 scale-110' : 'border-gray-300 hover:scale-105'
											}`}
